    ...
    return (
        <div className="min-h-screen bg-background text-foreground">
            <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
                ...
                {/* Header */}
                <div className="mb-8">
                    <p className="text-sm font-medium text-foreground/70">Teacher Account</p>
                    <h1 className="mt-1 text-3xl font-bold tracking-tight">My Profile</h1>
                    <p className="mt-2 text-sm text-foreground/90">View and update your personal information.</p>
                </div>
                        ...
                        <div className="flex flex-col items-center text-center">
                            <div className="relative">
                                <Avatar className="h-28 w-28 ring-2 ring-indigo-500/20">
                                    <AvatarImage
                                        src={user.image ? `${process.env.NEXT_PUBLIC_API_URL.replace(/\/$/, "")}${user.image}` : "/pp.jpg"}
                                        alt={user.name}
                                    />
                            ...
                            <div className="mt-4 rounded-full border border-indigo-500/40 bg-indigo-500/10 px-3 py-1 text-xs font-medium text-indigo-600 dark:text-indigo-400">Teacher</div>
                        </div>
